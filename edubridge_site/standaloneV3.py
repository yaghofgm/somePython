# important lines:
#     salary_options = np.arange(0.15,0.25,0.01).tolist() #establishes the ranges it tests for
#     leve = find_flexible_option(GPA, sex, university, course, country, loan_amount,
#                                 salary_range=np.arange(0.05, 0.15, 0.001), #0.05, 0.15, 0.001
#                                 months_range=range(120, 700, 12), #120, 200, 12
#                                 threshold=threshold, salary_base=salary_base)

#     intensa = find_flexible_option(GPA, sex, university, course, country, loan_amount,
#                                    salary_range=np.arange(0.30, 0.7, 0.01), #0.30, 0.7, 0.01
#                                    months_range=[60], #60
#                                    threshold=threshold, salary_base=salary_base)
...
def get_recommended_loans(GPA, sex, university, course, country, loan_amount,
    ...
    salary_options = np.arange(0.10,0.25,0.01).tolist() #establishes the ranges it tests for
    ...
    leve = find_flexible_option(GPA, sex, university, course, country, loan_amount,
                                salary_range=np.arange(0.05, 0.15, 0.001), #0.05, 0.15, 0.001
                                months_range=range(120, 300, 12), #120, 200, 12
                                threshold=threshold, salary_base=salary_base)
